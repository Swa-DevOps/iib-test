...
@ObjectClassDefinition(name = "Digio Create Mandate Servlet Config", description = "Configure Digio Create Mandate Servlet")
public @interface DigioCreateMandateServletConfig {
	...
	@AttributeDefinition(name = "Need to include Talsima Call", description = "")
	String getApplyTalsimaCall() default "No";
	...
	String corporate_config_id() default "TSE180110115609336HGUGFNECH3S5GA";
