package com.iib.platform.cfd.servlets;
 ...
 *
 */
@Component(service = { Servlet.class }, name = "Create CFD E-NACH Servlet", enabled = true, property = {
		Constants.SERVICE_DESCRIPTION + "=" + "Create CFD e-NACH Servlet",
		"sling.servlet.methods=" + HttpConstants.METHOD_POST, "sling.servlet.paths=" + "/bin/cfd/createEnach" })
public class CreateCFDEnachServlet extends SlingAllMethodsServlet {

	private static final long serialVersionUID = 1L;
	private static Logger log = LoggerFactory.getLogger(CreateCFDEnachServlet.class);
