...
$(document).on('click', '#sucessBtn', function (event) {

	window.location.assign("/content/enach-pl/home/thank-you.html");
});

$(document).on('click', '#faliureBtn', function (event) {

	window.location.assign("/content/enach-pl/home/sorry.html");
});

$(document).on('click', '#backBtn', function (event) {

	sessionStorage.setItem("backconfirmGUID", sessionStorage.getItem("confirmGUID"));
    sessionStorage.removeItem("confirmGUID");
