$(function(e) {
    ...
    updateTheBirthDayValue = function(e, a, t, r, n) {
        ...
        $birthday = e("<input class='birthDay' name='" + l + "_birthDay' type='hidden'/>"), i.placeholder && (e("<option value='0'>DD</option>").appendTo(s), e("<option value='0'>MM</option>").appendTo(p), e("<option value='0'>YY</option>").appendTo(d)), "bigEndian" == i.dateFormat ? o.append(s).append(p).append(d) : "littleEndian" == i.dateFormat ? o.append(s).append(p).append(d) : o.append(s).append(p).append(d);
        var h = r - i.minAge,
            c = r - i.maxAge;
        ...
        o.on("change", function() {
            ...
            updateTheBirthDayValue(i, $birthday, selectedDay, selectedMonth, selectedYear)
        })
